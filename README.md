# siteaudit-demo-industrial-systems
...
| --- | --- | --- | --- |
| `demo-01` | `siteaudit-demo-industrial-systems` | https://siteaudit-demo-industrial-systems.pages.dev/ | https://github.com/spyfu/siteaudit-demo-industrial-systems/edit/demo-01/siteaudit-head.html |
| `demo-02` | `siteaudit-demo-industrial-systems-02` | https://siteaudit-demo-industrial-systems-02.pages.dev/ | https://github.com/spyfu/siteaudit-demo-industrial-systems/edit/demo-02/siteaudit-head.html |
| `demo-03` | `siteaudit-demo-industrial-systems-03` | https://siteaudit-demo-industrial-systems-03.pages.dev/ | https://github.com/spyfu/siteaudit-demo-industrial-systems/edit/demo-03/siteaudit-head.html |
| `demo-04` | `siteaudit-demo-industrial-systems-04` | https://siteaudit-demo-industrial-systems-04.pages.dev/ | https://github.com/spyfu/siteaudit-demo-industrial-systems/edit/demo-04/siteaudit-head.html |
| `demo-05` | `siteaudit-demo-industrial-systems-05` | https://siteaudit-demo-industrial-systems-05.pages.dev/ | https://github.com/spyfu/siteaudit-demo-industrial-systems/edit/demo-05/siteaudit-head.html |
...
```powershell
git clone https://github.com/spyfu/siteaudit-demo-industrial-systems.git
Set-Location siteaudit-demo-industrial-systems
