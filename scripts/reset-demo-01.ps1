...
$expectedRepository = 'spyfu/siteaudit-demo-industrial-systems'
$expectedRemoteHttps = 'https://github.com/spyfu/siteaudit-demo-industrial-systems.git'
$expectedRemoteSsh = 'git@github.com:spyfu/siteaudit-demo-industrial-systems.git'
